...
# Reverting to the previous command without the custom settings file
...
find "$REPO_DIR" -type f -path "*/target/OffHighwayApplication-*.jar" -exec cp -v {} "$BUILD_DIR/" \;
